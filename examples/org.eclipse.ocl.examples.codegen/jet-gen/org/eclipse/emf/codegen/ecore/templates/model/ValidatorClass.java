...
public class ValidatorClass
{
  ...
  protected final String TEXT_50 = NL + "\tprotected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, ";
  protected final String TEXT_51 = " context)" + NL + "\t{" + NL + "\t\tswitch (classifierID)" + NL + "\t\t{";
  ...
  protected final String TEXT_173 = ";" + NL + "\t\tboolean ";
  ...
  protected final String TEXT_179 = " != null)" + NL + "\t\t\treportMaxLengthViolation(";
  protected final String TEXT_180 = " > ";
  protected final String TEXT_181 = "__LOWER_BOUND && ";
  protected final String TEXT_182 = " < ";
  protected final String TEXT_183 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_184 = NL + "\t\t\treportTotalDigitsViolation(";
  protected final String TEXT_185 = "), ";
  protected final String TEXT_186 = NL + "\t\tint scale = ";
  protected final String TEXT_187 = ".scale();" + NL + "\t\tint totalDigits = scale < 0 ? ";
  protected final String TEXT_188 = ".precision() - scale : ";
  protected final String TEXT_189 = ".precision();" + NL + "\t\tboolean ";
  protected final String TEXT_190 = " = totalDigits <= ";
  protected final String TEXT_191 = " != null)" + NL + "\t\t\treportTotalDigitsViolation(";
  protected final String TEXT_192 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_193 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  protected final String TEXT_194 = ".scale() <= ";
  protected final String TEXT_195 = " != null)" + NL + "\t\t\treportFractionDigitsViolation(";
  protected final String TEXT_196 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_197 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_198 = ".add";
  protected final String TEXT_199 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_200 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_201 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_202 = "\", getValueLabel(";
  protected final String TEXT_203 = ") },";
  protected final String TEXT_204 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_205 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_206 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_207 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_208 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_209 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_210 = ") }),";
  protected final String TEXT_211 = " }));";
  protected final String TEXT_212 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_213 = NL + "\t\treturn" + NL + "\t\t\tvalidate" + NL + "\t\t\t\t(";
  protected final String TEXT_214 = "," + NL + "\t\t\t\t ";
  protected final String TEXT_215 = "," + NL + "\t\t\t\t \"";
  protected final String TEXT_216 = "\",";
  protected final String TEXT_217 = NL + "\t\t\t\t \"";
  protected final String TEXT_218 = "__EEXPRESSION," + NL + "\t\t\t\t ";
  protected final String TEXT_219 = ".ERROR," + NL + "\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t 0);";
  protected final String TEXT_220 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_221 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_222 = "\", getObjectLabel(";
  protected final String TEXT_223 = NL + "\t/**" + NL + "\t * Returns the resource locator that will be used to fetch messages for this validator's diagnostics." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_224 = NL + "\tpublic ";
  protected final String TEXT_225 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_226 = NL + "\t\t// TODO" + NL + "\t\t// Specialize this to return a resource locator for messages specific to this validator." + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\treturn super.getResourceLocator();";
