...
public class AdapterFactoryClass
{
  ...
  protected final String TEXT_23 = "<@Nullable ";
  protected final String TEXT_24 = " modelSwitch =" + NL + "\t\tnew ";
  ...
  protected final String TEXT_30 = " object)" + NL + "\t\t\t{" + NL + "\t\t\t\treturn create";
  protected final String TEXT_31 = "Adapter();" + NL + "\t\t\t}";
  ...
  protected final String TEXT_41 = NL + "\t\t@Deprecated";
  protected final String TEXT_42 = NL + "\tpublic Adapter create";
  protected final String TEXT_43 = "Adapter()" + NL + "\t{" + NL + "\t\treturn null;" + NL + "\t}";
  protected final String TEXT_44 = NL + NL + "\t/**" + NL + "\t * Creates a new adapter for the default case." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * This default implementation returns null." + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the new adapter." + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Adapter create";
  protected final String TEXT_45 = "Adapter()" + NL + "\t{" + NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "} //";
