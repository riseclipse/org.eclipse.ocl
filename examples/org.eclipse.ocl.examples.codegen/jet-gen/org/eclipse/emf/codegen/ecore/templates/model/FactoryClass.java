...
public class FactoryClass
{
  ...
  protected final String TEXT_5 = NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * The <b>Factory</b> for the model." + NL + " * It provides a create method for each non-abstract class of the model." + NL + " * <!-- end-user-doc -->";
  protected final String TEXT_6 = NL + " * @see ";
  protected final String TEXT_7 = NL + " * ";
  protected final String TEXT_8 = NL + " * @generated" + NL + " */";
  protected final String TEXT_9 = NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * An implementation of the model <b>Factory</b>." + NL + " * <!-- end-user-doc -->";
  ...
  protected final String TEXT_41 = ": return ";
  protected final String TEXT_42 = "create";
  protected final String TEXT_43 = "();";
  protected final String TEXT_44 = NL + "\t\t\tdefault:" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"The class '\" + eClass.getName() + \"' is not a valid classifier\");";
  ...
  protected final String TEXT_47 = NL + "\tpublic Object createFromString(";
  protected final String TEXT_48 = " eDataType, String initialValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";
  protected final String TEXT_49 = ":" + NL + "\t\t\t\treturn create";
  protected final String TEXT_50 = "FromString(eDataType, initialValue);";
  protected final String TEXT_51 = NL + "\t\t\tdefault:" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"The datatype '\" + eDataType.getName() + \"' is not a valid classifier\");";
  protected final String TEXT_52 = NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_53 = NL + "\tpublic String convertToString(";
  protected final String TEXT_54 = " eDataType, Object instanceValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";
  protected final String TEXT_55 = ":" + NL + "\t\t\t\treturn convert";
  protected final String TEXT_56 = "ToString(eDataType, instanceValue);";
  ...
  protected final String TEXT_67 = "super.create(";
  ...
  protected final String TEXT_78 = "it";
  protected final String TEXT_79 = "literal";
  protected final String TEXT_80 = ")" + NL + "\t{";
  protected final String TEXT_81 = " result = ";
  protected final String TEXT_82 = ".get(literal);" + NL + "\t\tif (result == null) throw new IllegalArgumentException(\"The value '\" + literal + \"' is not a valid enumerator of '\" + ";
  protected final String TEXT_83 = ".getName() + \"'\");";
  protected final String TEXT_84 = NL + "\t\treturn result;";
  protected final String TEXT_85 = NL + "\t\treturn new ";
  protected final String TEXT_86 = "(create";
  protected final String TEXT_87 = "(literal));";
  protected final String TEXT_88 = NL + "\t\treturn create";
  protected final String TEXT_89 = "(literal);";
  protected final String TEXT_90 = ".create";
  protected final String TEXT_91 = ".createFromString(";
  protected final String TEXT_92 = ", literal);";
  protected final String TEXT_93 = NL + "\t\tif (literal == null) return null;" + NL + "\t\t";
  protected final String TEXT_94 = " result = new ";
  protected final String TEXT_95 = "<";
  protected final String TEXT_96 = ">";
  protected final String TEXT_97 = NL + "\t\tfor (";
  protected final String TEXT_98 = " stringTokenizer = new ";
  protected final String TEXT_99 = "(literal); stringTokenizer.hasMoreTokens(); )";
  protected final String TEXT_100 = NL + "\t\tfor (String item : split(literal))";
  protected final String TEXT_101 = NL + "\t\t{";
  protected final String TEXT_102 = NL + "\t\t\tString item = stringTokenizer.nextToken();";
  protected final String TEXT_103 = NL + "\t\t\tresult.add(create";
  protected final String TEXT_104 = "(item));";
  protected final String TEXT_105 = "FromString(";
  protected final String TEXT_106 = ", item));";
  protected final String TEXT_107 = NL + "\t\t\tresult.add(";
  protected final String TEXT_108 = NL + "\t\t}" + NL + "\t\treturn result;";
  protected final String TEXT_109 = NL + "\t\tif (literal == null) return ";
  protected final String TEXT_110 = ";" + NL + "\t\t";
  protected final String TEXT_111 = ";" + NL + "\t\tRuntimeException exception = null;";
  protected final String TEXT_112 = NL + "\t\ttry" + NL + "\t\t{";
  protected final String TEXT_113 = NL + "\t\t\tresult = create";
  protected final String TEXT_114 = NL + "\t\t\tresult = (";
  protected final String TEXT_115 = ")create";
  protected final String TEXT_116 = NL + "\t\t\tresult = ";
  protected final String TEXT_117 = NL + "\t\t\tif (";
  protected final String TEXT_118 = "result != null && ";
  protected final String TEXT_119 = ".INSTANCE.validate(";
  protected final String TEXT_120 = ", ";
  protected final String TEXT_121 = "new ";
  protected final String TEXT_122 = "(result)";
  protected final String TEXT_123 = "result";
  protected final String TEXT_124 = ", null, null))" + NL + "\t\t\t{" + NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (RuntimeException e)" + NL + "\t\t{" + NL + "\t\t\texception = e;" + NL + "\t\t}";
  protected final String TEXT_125 = NL + "\t\tif (";
  protected final String TEXT_126 = "result != null || ";
  protected final String TEXT_127 = "exception == null) return result;" + NL + "    " + NL + "\t\tthrow exception;";
  protected final String TEXT_128 = NL + "\t\treturn (";
  protected final String TEXT_129 = ")super.createFromString(literal);";
  protected final String TEXT_130 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new ";
  protected final String TEXT_131 = NL + "\t\treturn ((";
  protected final String TEXT_132 = ")super.createFromString(";
  protected final String TEXT_133 = ", literal)).";
  protected final String TEXT_134 = "super.createFromString(";
  protected final String TEXT_135 = NL + "\t}" + NL;
  protected final String TEXT_136 = " eDataType, String initialValue)" + NL + "\t{";
  protected final String TEXT_137 = "(initialValue);";
  protected final String TEXT_138 = ".get(initialValue);" + NL + "\t\tif (result == null) throw new IllegalArgumentException(\"The value '\" + initialValue + \"' is not a valid enumerator of '\" + eDataType.getName() + \"'\");";
  protected final String TEXT_139 = ", initialValue);";
  protected final String TEXT_140 = NL + "\t\tif (initialValue == null) return null;" + NL + "\t\t";
  protected final String TEXT_141 = "(initialValue); stringTokenizer.hasMoreTokens(); )";
  protected final String TEXT_142 = NL + "\t\tfor (String item : split(initialValue))";
  protected final String TEXT_143 = "(initialValue));";
  protected final String TEXT_144 = " result = null;" + NL + "\t\tRuntimeException exception = null;";
  protected final String TEXT_145 = NL + "\t\t\tif (result != null && ";
  protected final String TEXT_146 = ".INSTANCE.validate(eDataType, result, null, null))" + NL + "\t\t\t{" + NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (RuntimeException e)" + NL + "\t\t{" + NL + "\t\t\texception = e;" + NL + "\t\t}";
  protected final String TEXT_147 = NL + "\t\tif (result != null || exception == null) return result;" + NL + "    " + NL + "\t\tthrow exception;";
  protected final String TEXT_148 = "super.createFromString(initialValue);";
  protected final String TEXT_149 = "super.createFromString(eDataType, initialValue);";
  protected final String TEXT_150 = NL + "\tpublic String convert";
  protected final String TEXT_151 = "instanceValue";
  protected final String TEXT_152 = NL + "\t\treturn instanceValue == null ? null : instanceValue.toString();";
  protected final String TEXT_153 = NL + "\t\treturn instanceValue == null ? null : convert";
  ...
  protected final String TEXT_196 = NL + "\t\tthrow new IllegalArgumentException(\"Invalid value: '\"+instanceValue+\"' for datatype :\"+eDataType.getName());";
  ...
  protected final String TEXT_201 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return a new object of class '<em>";
  protected final String TEXT_202 = "</em>'.";
  protected final String TEXT_203 = NL + "\t";
  protected final String TEXT_204 = "();" + NL;
  protected final String TEXT_205 = NL + "\t/**" + NL + "\t * Returns an instance of data type '<em>";
  protected final String TEXT_206 = "</em>' corresponding the given literal." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param literal a literal of the data type." + NL + "\t * @return a new instance value of the data type.";
  protected final String TEXT_207 = "(String literal);" + NL + "" + NL + "\t/**" + NL + "\t * Returns a literal representation of an instance of data type '<em>";
  protected final String TEXT_208 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param instanceValue an instance value of the data type." + NL + "\t * @return a literal representation of the instance value.";
  ...
  protected final String TEXT_214 = ")getEPackage();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @deprecated" + NL + "\t * @generated" + NL + "\t */";
