...
public class FactoryClass
{
  ...
  protected final String TEXT_12 = NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * An implementation of the model <b>Factory</b>." + NL + " * <!-- end-user-doc -->";
  protected final String TEXT_13 = NL + "@Deprecated";
  protected final String TEXT_14 = NL + "@SuppressWarnings(\"deprecation\")";
