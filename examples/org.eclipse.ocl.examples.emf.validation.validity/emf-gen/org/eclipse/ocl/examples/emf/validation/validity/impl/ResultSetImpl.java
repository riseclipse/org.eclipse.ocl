 ...
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.validity.impl.ResultSetImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultSetImpl extends MinimalEObjectImpl.Container implements ResultSet {
	...
	public String getName() {
		...
		@NonNull Iterator<Object> ITERATOR__1 = BOXED_results.iterator();
		/*@NonInvalid*/ @NonNull BagValue severities;
		while (true) {
			...
			@SuppressWarnings("null")
			/*@NonInvalid*/ @NonNull Result _1 = (@NonNull Result)ITERATOR__1.next();
			/**
			 * severity
			 */
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull Severity severity = _1.getSeverity();
			final /*@NonInvalid*/ @NonNull EnumerationLiteralId BOXED_severity = ValidityTables.ENUMid_Severity.getEnumerationLiteralId(ClassUtil.nonNullState(severity.getName()));
			//
			accumulator.add(BOXED_severity);
		}
		final /*@NonInvalid*/ @NonNull IntegerValue count = CollectionCountOperation.INSTANCE.evaluate(severities, ValidityTables.ELITid_ERROR);
		final /*@NonInvalid*/ @NonNull String toString = OclAnyToStringOperation.INSTANCE.evaluate(count);
		final /*@NonInvalid*/ @NonNull String sum = StringConcatOperation.INSTANCE.evaluate(toString, ValidityTables.STR__32_errors_32);
		final /*@NonInvalid*/ @NonNull IntegerValue count_0 = CollectionCountOperation.INSTANCE.evaluate(severities, ValidityTables.ELITid_WARNING);
		final /*@NonInvalid*/ @NonNull String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(count_0);
		final /*@NonInvalid*/ @NonNull String sum_0 = StringConcatOperation.INSTANCE.evaluate(sum, toString_0);
		final /*@NonInvalid*/ @NonNull String sum_1 = StringConcatOperation.INSTANCE.evaluate(sum_0, ValidityTables.STR__32_warnings_32);
		final /*@NonInvalid*/ @NonNull IntegerValue count_1 = CollectionCountOperation.INSTANCE.evaluate(severities, ValidityTables.ELITid_INFO);
		final /*@NonInvalid*/ @NonNull String toString_1 = OclAnyToStringOperation.INSTANCE.evaluate(count_1);
		final /*@NonInvalid*/ @NonNull String sum_2 = StringConcatOperation.INSTANCE.evaluate(sum_1, toString_1);
		final /*@NonInvalid*/ @NonNull String sum_3 = StringConcatOperation.INSTANCE.evaluate(sum_2, ValidityTables.STR__32_infos_32);
		final /*@NonInvalid*/ @NonNull IntegerValue count_2 = CollectionCountOperation.INSTANCE.evaluate(severities, ValidityTables.ELITid_OK);
		final /*@NonInvalid*/ @NonNull String toString_2 = OclAnyToStringOperation.INSTANCE.evaluate(count_2);
		final /*@NonInvalid*/ @NonNull String sum_4 = StringConcatOperation.INSTANCE.evaluate(sum_3, toString_2);
		final /*@NonInvalid*/ @NonNull String sum_5 = StringConcatOperation.INSTANCE.evaluate(sum_4, ValidityTables.STR__32_oks);
		return sum_5;
	}
