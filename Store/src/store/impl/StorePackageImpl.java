...
public class StorePackageImpl extends EPackageImpl implements StorePackage {
	 ...
	 * @generated
	 */
	public EReference getStore_Artists() {
	 ...
	 * @generated
	 */
	public EAttribute getBook_PageCount() {
	 ...
	 * @generated
	 */
	public EAttribute getCD_TrackCount() {
	 ...
	 * @generated
	 */
	public EReference getCD_Singer() {
	...
	public void createPackageContents() {
		...
		createEReference(storeEClass, STORE__ARTISTS);
		...
		createEAttribute(bookEClass, BOOK__PAGE_COUNT);
		createEReference(bookEClass, BOOK__AUTHOR);

		cdEClass = createEClass(CD);
		createEAttribute(cdEClass, CD__TRACK_COUNT);
		createEReference(cdEClass, CD__SINGER);
	...
	public void initializePackageContents() {
		...
		cdEClass.getESuperTypes().add(this.getProduct());
		...
		initEReference(getStore_Artists(), this.getPerson(), null, "artists", null, 0, -1, Store.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getBook_PageCount(), ecorePackage.getEInt(), "pageCount", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getBook_Author(), this.getPerson(), null, "author", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(cdEClass, store.CD.class, "CD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCD_TrackCount(), ecorePackage.getEInt(), "trackCount", null, 0, 1, store.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getCD_Singer(), this.getPerson(), null, "singer", null, 0, 1, store.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
