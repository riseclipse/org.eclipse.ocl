...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull Operation op_Real_cbrt = createOperation("cbrt", _Real, "org.eclipse.ocl.pivot.library.numeric.NumericCbrtOperation", org.eclipse.ocl.pivot.library.numeric.NumericCbrtOperation.INSTANCE);
		...
		private final @NonNull Operation op_Real_log = createOperation("log", _Real, "org.eclipse.ocl.pivot.library.numeric.NumericLogOperation", org.eclipse.ocl.pivot.library.numeric.NumericLogOperation.INSTANCE);
		private final @NonNull Operation op_Real_log10 = createOperation("log10", _Real, "org.eclipse.ocl.pivot.library.numeric.NumericLog10Operation", org.eclipse.ocl.pivot.library.numeric.NumericLog10Operation.INSTANCE);
		...
		private final @NonNull Operation op_Real_pow = createOperation("pow", _Real, "org.eclipse.ocl.pivot.library.numeric.NumericPowOperation", org.eclipse.ocl.pivot.library.numeric.NumericPowOperation.INSTANCE);
		...
		private final @NonNull Operation op_Real_sqrt = createOperation("sqrt", _Real, "org.eclipse.ocl.pivot.library.numeric.NumericSqrtOperation", org.eclipse.ocl.pivot.library.numeric.NumericSqrtOperation.INSTANCE);
		...
		private final @NonNull Operation op_String_split = createOperation("split", _Sequence_String_T, "org.eclipse.ocl.pivot.library.string.StringSplitOperation", org.eclipse.ocl.pivot.library.string.StringSplitOperation.INSTANCE);
		...
		private void installOperations() {
			...
			ownedOperations.add(operation = op_Real_cbrt);
			ownedOperations.add(operation = op_Real_cos);
			ownedOperations.add(operation = op_Real_floor);
			ownedOperations.add(operation = op_Real_log);
			ownedOperations.add(operation = op_Real_log10);
		...
		private final @NonNull Iteration it_Bag_breadthClosure = createIteration("breadthClosure", _Set_Bag_T_T, "org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration", org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration.INSTANCE);
		...
		private final @NonNull Iteration it_OrderedSet_breadthClosure = createIteration("breadthClosure", _OrderedSet_OrderedSet_T, "org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration", org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Sequence_breadthClosure = createIteration("breadthClosure", _OrderedSet_Sequence_T_T, "org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration", org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Set_breadthClosure = createIteration("breadthClosure", _Set_Set_T, "org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration", org.eclipse.ocl.pivot.library.iterator.BreadthClosureIteration.INSTANCE);
		...
		private void installIterations() {
			...
			ownedIterations.add(iteration = it_Bag_breadthClosure);
			...
			ownedIterations.add(iteration = it_OrderedSet_breadthClosure);
			ownedParameters = iteration.getOwnedIterators();
			...
			ownedIterations.add(iteration = it_Sequence_breadthClosure);
			ownedParameters = iteration.getOwnedIterators();
			...
			ownedIterations.add(iteration = it_Set_breadthClosure);
			ownedParameters = iteration.getOwnedIterators();
		...
		private void installComments() {
			...
			installComment(op_Real_acos, "The inverse cosine of oclText[self].");
			installComment(op_Real_asin, "The inverse sine of oclText[self].");
			installComment(op_Real_atan, "The inverse tangent of oclText[self].");
			installComment(op_Real_cbrt, "The cube root of oclText[self].");
			installComment(op_Real_cos, "The cosine of oclText[self].");
			installComment(op_Real_floor, "The largest integer that is less than or equal to oclText[self].");
			installComment(op_Real_log, "The log of oclText[self].");
			installComment(op_Real_log10, "The log of oclText[self].");
			installComment(op_Real_max, "The maximum of oclText[self] and r.");
			installComment(op_Real_min, "The minimum of oclText[self] and r.");
			installComment(op_Real_pow, "The result of oclText[self] at power r.");
			...
			installComment(op_Real_sin, "The sine of oclText[self].");
			installComment(op_Real_sqrt, "The square root of oclText[self].");
			installComment(op_Real_tan, "The tangent of oclText[self].");
			...
			installComment(op_String_split, "Return a sequence of split parts in oclText[self] divided by regex.");
			...
			installComment(it_Bag_breadthClosure, "The closure of applying body transitively to every distinct element of the source collection.");
			...
			installComment(it_OrderedSet_breadthClosure, "The closure of applying body transitively to every distinct element of the source collection.");
			...
			installComment(it_Sequence_breadthClosure, "The closure of applying body transitively to every distinct element of the source collection.");
			...
			installComment(op_Sequence_weightedAverage, "The weighted average of oclText[self], oclText[self] and oclText[weights] must have the same size.");
			...
			installComment(it_Set_breadthClosure, "The closure of applying body transitively to every distinct element of the source collection.");
