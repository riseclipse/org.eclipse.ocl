...
/**
 * NumericCosOperation realises the cos() library operation.
 */
public class NumericCosOperation extends AbstractSimpleUnaryOperation {
	
	public static final @NonNull NumericCosOperation INSTANCE = new NumericCosOperation();
	
	@Override
	public @NonNull RealValue evaluate(@Nullable Object sourceVal) {
		RealValue numericValue = asRealValue(sourceVal); 
		double d = Math.cos(numericValue.asDouble());
