...
/**
 * NumericAsinOperation realises the asin() library operation.
 */
public class NumericAsinOperation extends AbstractSimpleUnaryOperation {
	...
	public @NonNull RealValue evaluate(@Nullable Object sourceVal) {
		...
		if (doubleValue>1 || doubleValue<-1) {
			throw new InvalidValueException(PivotMessages.InvalidOperation,"asin",doubleValue);
		}
		double d = Math.asin(doubleValue);
