...
/**
 * NumericAtanOperation realises the atan() library operation.
 */
public class NumericAtanOperation extends AbstractSimpleUnaryOperation {
	
	public static final @NonNull NumericAtanOperation INSTANCE = new NumericAtanOperation();
	
	@Override
	public @NonNull RealValue evaluate(@Nullable Object sourceVal) {
		RealValue numericValue = asRealValue(sourceVal); 
		double d = Math.atan(numericValue.asDouble());
